...
void set_Valve(void)
{
	HAL_GPIO_WritePin(Vaccuum_Valve_GPIO_Port, Vaccuum_Valve_Pin,
			GPIO_PIN_RESET);
}
...
{
	return HAL_GPIO_ReadPin(Endstop_X_GPIO_Port, Endstop_X_Pin)
			== GPIO_PIN_RESET;
}
int get_Endstop_Z(void)
{
	return HAL_GPIO_ReadPin(Endstop_Z_GPIO_Port, Endstop_Z_Pin)
			== GPIO_PIN_RESET;
}

int get_Rotary_C1(void)
{
	return HAL_GPIO_ReadPin(Rotary_Switch_C1_GPIO_Port, Rotary_Switch_C1_Pin)
			== GPIO_PIN_SET;
}
int get_Rotary_C2(void)
{
	return HAL_GPIO_ReadPin(Rotary_Switch_C2_GPIO_Port, Rotary_Switch_C2_Pin)
			== GPIO_PIN_SET;
}
int get_Rotary_C4(void)
{
	return HAL_GPIO_ReadPin(Rotary_Switch_C4_GPIO_Port, Rotary_Switch_C4_Pin)
			== GPIO_PIN_SET;
}
int get_Rotary_C8(void)
{
	return HAL_GPIO_ReadPin(Rotary_Switch_C8_GPIO_Port, Rotary_Switch_C8_Pin)
			== GPIO_PIN_SET;

}
int get_Start_Selector(void)
{
	return HAL_GPIO_ReadPin(Pushbutton_Rotary_Switch_GPIO_Port,
			Pushbutton_Rotary_Switch_Pin) == GPIO_PIN_SET;
}
/* USER CODE END 2 */
