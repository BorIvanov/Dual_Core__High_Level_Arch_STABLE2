...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(Encoder_X_A_GPIO_Port, Encoder_X_A_Pin);

    HAL_GPIO_DeInit(Encoder_X_B_GPIO_Port, Encoder_X_B_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, Encoder_Z_A_Pin|Encoder_Z_B_Pin);
...
/* USER CODE BEGIN 1 */
void set_Motor_X_PWM(float percent){
	CH3_DC = (int)(((percent*0.8f)+0.1f) * (48000-1));
	TIM2->CCR3 = CH3_DC;
}
void set_Motor_Z_PWM(float percent){
